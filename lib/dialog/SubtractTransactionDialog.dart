...
class SubtractTransactionDialog extends StatefulWidget {

  String _type;

  SubtractTransactionDialog(this._type);

  @override
  State<StatefulWidget> createState() =>
      SubtractTransactionDialogState(this._type);
}

  class SubtractTransactionDialogState extends State<SubtractTransactionDialog> {
  ...
  SubtractTransactionDialogState(String type) {
    this._type = type;
      ...
      children: <Widget>[
        Padding(
          ...
          child: Column(
            children: <Widget>[
              InkWell(child: Text(
                model.categoryName == null ? "Select Category" : model
                    .categoryName, style: TextStyle(color: Colors.white),),
                onTap: () async {
